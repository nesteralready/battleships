...
/* package network-uri-flag-0.1 */
#ifndef VERSION_network_uri_flag
#define VERSION_network_uri_flag "0.1"
#endif /* VERSION_network_uri_flag */
#ifndef MIN_VERSION_network_uri_flag
#define MIN_VERSION_network_uri_flag(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_network_uri_flag */
...
#define CURRENT_COMPONENT_ID "project-0.1.0.0-inplace-project-exe"
